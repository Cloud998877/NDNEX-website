...
export const Home: React.FC = () => {
  ...
  const MEDIUM_LOGOS = [
    // Optus moved to EXTRA_SMALL, "Boehringer Ingelheim"
  ];
    ...
    <div className="flex flex-col w-full overflow-hidden font-sans bg-slate-50">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          {/* Updated Image: Abstract Data / Evidence / Structure  */}
          <img 
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="space-y-8">
              ...
              <h3 className="text-4xl md:text-5xl font-bold text-ndnex-dark font-display leading-tight">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-ndnex-orange to-orange-600">Innovation</span> and <span className="text-transparent bg-clip-text bg-gradient-to-r from-ndnex-blue to-indigo-600">Access</span>.
              </h3>
              <p className="text-gray-600 text-xl leading-relaxed font-light">
                In a rapidly evolving healthcare landscape, data is only as valuable as the insights it generates. We combine deep scientific expertise with strategic market understanding to build compelling value stories that resonate with payers and policymakers.
              </p>
              ...
              <div className="pt-4">
                <Link to="/about" className="inline-flex items-center gap-3 text-ndnex-dark font-bold text-lg hover:gap-5 transition-all group">
                  <span className="border-b-2 border-ndnex-dark group-hover:border-ndnex-orange transition-colors">Learn about our Mission</span>
                ...
                <div className="absolute bottom-8 left-8 right-8 bg-white/95 backdrop-blur-md p-6 rounded-xl shadow-lg border border-gray-100 animate-float hidden md:block">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 mt-1 leading-relaxed">Robust methodologies ensuring regulatory and reimbursement success through data-driven insights.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
           <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6 border-b border-white/10 pb-8">
             <div>
                ...
                <p className="text-gray-400 text-lg font-light max-w-xl">Trusted by over 60 industry leaders in biopharma and medtech to solve their most complex challenges.</p>
             </div>
