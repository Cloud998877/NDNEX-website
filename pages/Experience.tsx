      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                ...
                <div className="p-6">
                  <div className="flex flex-wrap gap-2">
                    {area.diseases.map((disease, dIdx) => (
                      <span 
                        key={dIdx} 
                        className="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-medium bg-gray-50 text-gray-700 border border-gray-100 hover:bg-ndnex-blue/5 hover:text-ndnex-blue hover:border-ndnex-blue/20 transition-colors"
                      >
        ...
        <div className="border-t border-gray-200 pt-24">
          <div className="flex items-center gap-4 mb-12">
            ...
            <h2 className="text-3xl font-bold text-ndnex-dark font-display">
          ...
          <div className="grid gap-6">
            {PUBLICATIONS.map((pub, idx) => (
              <div 
                key={idx} 
                className="bg-white p-8 rounded-2xl border border-gray-200 hover:border-ndnex-orange/50 hover:shadow-lg transition-all group relative overflow-hidden"
              >
                ...
                <div className="flex flex-col md:flex-row justify-between gap-6 pl-4">
                  ...
                  <div className="flex-grow">
                    <div className="flex flex-wrap items-center gap-3 text-xs font-bold mb-3">
                      ...
                      <span className="text-ndnex-blue uppercase tracking-wider bg-blue-50 px-2 py-1 rounded">
                        {pub.journal}
                      </span>
                    </div>
                    ...
                    <p className="text-base text-gray-600 font-medium">{pub.authors}</p>
                  </div>
        ...
        {/* ✅ Bottom CTA (제대로 된 위치) */}
        <div className="mt-16 bg-ndnex-dark rounded-2xl p-8 text-center relative overflow-hidden shadow-2xl animate-fade-in-up">
          <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10"></div>
          <div className="relative z-10">
            <h3 className="text-2xl md:text-2xl font-bold text-white font-display mb-4">
            ...
            <a 
              href="#/contact" 
              className="inline-flex items-center gap-2 bg-ndnex-orange text-white px-6 py-4 rounded-full font-bold hover:bg-orange-600 transition-all shadow-lg hover:shadow-orange-900/20"
            >
