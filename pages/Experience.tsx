  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        {/* ✅ Bottom CTA (제대로 된 위치) */}
        <div className="mt-24 bg-ndnex-dark rounded-3xl p-12 text-center relative overflow-hidden shadow-2xl animate-fade-in-up">
          ...
          <div className="relative z-10">
            ...
            <a 
              href="#/contact" 
              className="inline-flex items-center gap-2 bg-ndnex-orange text-white px-8 py-4 rounded-full font-bold hover:bg-orange-600 transition-all shadow-lg hover:shadow-orange-900/20"
            >
